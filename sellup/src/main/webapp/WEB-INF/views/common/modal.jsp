<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div id="myModal" class="modal">
		...
		<h3 style="text-align: center;">신고하기</h3>
			<form name="frmReport" method="post" action="${contextPath }/community/report">
			<table class="table" style="width: 50%">
				...
				<tr>
					<th>신고할 ID</th>
					<td><input value="psh5314@naver.com" readonly="readonly"></td>
				</tr>
				<tr>
					<th>제목</th>
			...
			<!-- 		<td>
					<input type="radio" value="음란물">음란물
					<input type="radio" value="광고">광고
					<input type="radio" value="혐오성 게시물">혐오성 게시물
					<input type="radio" value="혐오성 발언">혐오성 발언
					</td> -->
				</tr>
				<tr>
					<th>이미지 첨부</th>
					<td><input class="file" type="file" name="filename" accept="image/*"></td>
				</tr>
				<tr>
