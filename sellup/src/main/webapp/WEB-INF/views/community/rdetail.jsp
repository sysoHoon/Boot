...
<br>
<h2 style="text-align: center;">내 신고 상세</h2>
<br>
 <table style="width:50%;margin:auto;">
 	...
 	<tr>
 		...
 		<td class="td1">신고할 ID</td>
 		<td class="input1">psh5314@naver.com</td>
 	</tr>
 	...
 	<tr>
 		...
 		<a href="http://localhost:8082/uploads/${bean.filename }"><img src="/uploads/${bean.filename}" width="400px" height="400px" style="object-fit:cover"></a>
 		</c:if>
 		<c:if test="${bean.filename == null }">
 		첨부된 이미지가 없습니다.
 		</c:if>
