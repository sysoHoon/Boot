...
<form name="frm1" method="post" action="update">
 ...
 <table>
 	<tr><td width="100px" class="td1">제목</td>
 		<td class="left"><input type="text" name="subject" value="${bean.subject}" size="70" class="input1" required="required"></td>
 	</tr>
 	<tr><td class="td1">작성자</td>
 		<td class="left"><input type="text" name="name" value="${bean.writer}" size="70" class="input1" disabled></td>
 	</tr>
