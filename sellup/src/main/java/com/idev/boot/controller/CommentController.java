...
public class CommentController {
	...
	public String insert(@ModelAttribute TimelineBoardComments comt,int page,RedirectAttributes redirectAttributes ) {
	...
	//	model.addAttribute("page", page);
		redirectAttributes.addAttribute("idx", comt.getTimeline_board_id());
